...
public class HandTest {
	...
	public void test2() 
	{
		ArrayList<Card> cards = new ArrayList<Card>();
		cards.add(new Card(eRank.TWO,eSuit.CLUBS));
		cards.add(new Card(eRank.THREE,eSuit.HEARTS));
		cards.add(new Card(eRank.JACK,eSuit.SPADES));
		int[] score = HandHelper(cards);
	...
	public void test3() 
	{
		...
		cards.add(new Card(eRank.THREE,eSuit.HEARTS));
		cards.add(new Card(eRank.JACK,eSuit.SPADES));
		cards.add(new Card(eRank.JACK,eSuit.DIAMONDS));
		int[] score = HandHelper(cards);
